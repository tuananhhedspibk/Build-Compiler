...
struct ProcedureAttributes_ {
	...
	int paramCount;							// --- The number of the param ---
	CodeAddress codeAddress;				// --- Location of procedure ---
};
...
struct FunctionAttributes_ {
	...
	int paramCount;							// --- The number of the param ---
	CodeAddress codeAddress;				// --- Location of func ---
};

struct ProgramAttributes_ {
	struct Scope_ *scope;
	CodeAddress codeAddress;				// --- Location ---
};
...
struct Scope_ {
	...
	Object *owner;
	struct Scope_ *outer;
	int frameSize;								// --- The size of the frame ---
};
...
struct SymTab_ {
	...
	ObjectNode *globalObjectList;				// --- WRITEI, WRITEC, WRITELN, READC, READI, ---
};
